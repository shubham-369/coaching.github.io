...
if(isset($_POST['submit'])=="submitted"){
	...
	$sql = "INSERT INTO `form` (`name`, `number`, `email`, `course`, `message`) VALUES ('$name','$number','$email','$course','$message')";
	if(mysqli_query($conn,$sql)){
		echo "<script>console.log('recorded successfully');</script>";
	}
	else{
		echo "<script>console.log('record unsuccessfull');</script>";
	}
	}
?>
<!doctype html>
		...
		<a class=" fs navbar-brand text-danger brand-font px-3" href="#">VISION <span class = "text-secondary">INSTITUTE</span></a>
		  ...
		  <div class="collapse navbar-collapse justify-content-end" id="navbar">
			<ul class="navbar-nav d-flex px-3">
			  ...
			  <li class="nav-item h5"><a class="nav-link" href="gallery.php#certificates">Certificates</a></li>
		...
		<div class = "row">
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/basics" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/ms-office" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/typing" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/shorthand" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/mangal" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/adcm" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/dca" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/hardware" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/tally" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/photoshop" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/pagemaker" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
			...
			<div class = "col-md-4 col-6 pt-3">
				<div class = "card shadow">
					<img src  = "images/corel-draw" class = "card-img-top" style = "height: 12rem; object-fit: cover;"/>
					<div class = "card-body">
		...
		<div class = "row bg-light">
			...
			<div class = "col-md-6">
				<ul class = "footer-nav float-right">
					<li class = "nav-items p-2"><a href ="index.php" class = "text-danger footer-links">Home</a></li>
					...
					<li class = "nav-items p-2"><a href ="gallery.php#certificates" class = "text-danger footer-links">Certificates</a></li>
